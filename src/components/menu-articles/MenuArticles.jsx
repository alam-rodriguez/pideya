...
const MenuArticles = () => {
  ...
  if(categoriesOfMenu != null){
    return (
      <main className={`d-flex flex-column flex-grow-1 h-100 overflow-hidden col-12 col-md-6 mx-auto ${!haEstadoEnMenu ? 'animate__animated animate__fadeIn' : ''} z-3 px-3- vh-100- ${viewPreviewInfoArticle ? 'animate__animatedanimate__fadeIn z-0 bg-black bg-opacity-25 z-3' : ''}`} style={{maxHeight:'100vh'}}>
