  ...
  if(categoriesOfMenu != null){
    return (
      <main onScroll={handleScroll}>
        ...
        <div className={`d-flex flex-column flex-grow-1 col-12 col-md-6 mx-auto ${!haEstadoEnMenu ? 'animate__animated animate__fadeIn' : ''} z-3 px-3-  ${viewPreviewInfoArticle ? 'animate__animatedanimate__fadeIn z-0 bg-black bg-opacity-25 z-3' : ''}`} style={{maxHeight:'100vh'}} onScroll={handleScroll}>
