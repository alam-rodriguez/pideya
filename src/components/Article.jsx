...
const Article = ({viewArticleSelected, setViewArticleSelected}) => { 
  ...
  if(articleSeleted != null){
    return (
      <main className={`animate__animated ${viewArticleSelected=='abrir' ? 'animate__slideInRight' : viewArticleSelected=='cerrar' ? 'animate__slideOutRight' : ''}  container-fluid p-0 position-fixed start-0 top-0 h-100 bg-light z-3`}>
