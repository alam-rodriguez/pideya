...
const SingInButton = ({icon, bgColor, text, handleClick}) => {
  ...
  return (
    <button className='overflow-hidden d-flex align-items-center bg-white border-1 border-secondary rounded-3 row w-100 form-control my-3 p-0' style={{height:35}} onClick={handleClick}>
