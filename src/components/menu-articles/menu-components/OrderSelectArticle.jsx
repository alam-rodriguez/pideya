...
const OrderSelectArticle = ({setViewMenu, setViewOrderSelectArticle, articlesOfCategorySelected}) => {
  ...
  return (
    <div className={`animate__animated ${!close ? 'animate__fadeIn': 'animate__fadeOut'} position-absolute top-0 start-0 w-100 bg-white vh-100- overflow-hidden z-3 h-100`} style={{}}>
